...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <div class="jumbotron">
      <div class="container">
        <h1 class="heading">Recoveries for Samsung Golden <small>(GT-I8190)</small></h1>
      </div>
    </div>
    ...
    <div class="container">
      <div class="jumbotron">
        ...
        <p>For Questions and Feedback please use the <a href="http://forum.xda-developers.com/showthread.php?t=2774070">Recovery Thread on XDA</a>.</p>
      </div>
    </div>
